...
public class Template_UIManagerCustom : MonoBehaviour
{
    #region VARS
    ...
    public TMPro.TextMeshProUGUI NPC_TextMeshPro_Text;
    ...
    void Begin(VIDE_Assign dialogue)
    {
        ...
        playerLabel.text = "";
        //custom
        if (NPC_TextMeshPro_Text != null)
            NPC_Text.text = NPC_TextMeshPro_Text.text;
    ...
    void UpdateUI(VD.NodeData data)
    {
        ...
        foreach (Button b in maxPlayerChoices) {
            if(b.transform.GetChild(0).GetComponent<Text>() == null) {
